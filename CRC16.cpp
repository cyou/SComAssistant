...
void CRC16::Modbus_CRC16(uint8 *Buff_addr,uint16 len)
{                                              // 函数返回值是无符号短整型CRC值
                                               // 待进行CRC校验计算的报文
                                               // 待校验的报文长度
...
{
	return this->m_crc_hi;
}
uint8 CRC16::CRC16_Lo()
{
	return this->m_crc_lo;
}